...
<body>
    ...
    <section>
        <div class="relative">
            ...
            <h1 class="absolute z-40 text-center text-white cfonts-Staatliche font-bold font-sans text-6xl top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2">
            ...
            <div class="flex flex-wrap md:-m-2 -m-1">
                <div class="flex flex-wrap w-1/2">
                    <div class="md:p-2 p-1 w-1/2">
                        <a href="pdp.php">
                            <img alt="gallery" class="w-full object-cover h-full object-center block rounded-3xl" src="images/1.jpg">
                        </a>
                    </div>
                    <div class="md:p-2 p-1 w-1/2">
                        <a href="pdp2.php">
                            <img alt="gallery" class="w-full object-cover h-full object-center block rounded-3xl" src="images/2.jpg">
                        </a>
                    </div>
                    <div class="md:p-2 p-1 w-full">
                        <a href="pdp3.php">
                            <img alt="gallery" class="w-full h-full object-cover object-center block rounded-3xl" src="images/3.jpg">
                        </a>
                    </div>
                </div>
                <div class="flex flex-wrap w-1/2">
                    <div class="md:p-2 p-1 w-full">
                        <a href="pdp4.php">
                            <img alt="gallery" class="w-full h-full object-cover object-center block rounded-3xl" src="images/4.jpg">
                        </a>
                    </div>
                    <div class="md:p-2 p-1 w-1/2">
                        <a href="pdp5.php">
                            <img alt="gallery" class="w-full object-cover h-full object-center block rounded-3xl" src="images/5.jpg">
                        </a>
                    </div>
                    <div class="md:p-2 p-1 w-1/2">
                        <a href="pdp6.php">
                            <img alt="gallery" class="w-full object-cover h-full object-center block rounded-3xl" src="images/6.jpg">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="">
            ...
            <div class="sliderAx h-auto">
                ...
                <div id="slider-2" class="container mx-auto">
                    <div class="bg-cover bg-top  h-auto text-white py-24 px-10 object-fill" style="background-image: url(https://source.unsplash.com/1600x900/?books,library)">
                ...
                <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <div class="flex items-center justify-center h-24 w-24 rounded-full bg-indigo-500 text-white">
                                <!-- Heroicon name: globe-alt -->
                                <svg class="h-16 w-16" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
