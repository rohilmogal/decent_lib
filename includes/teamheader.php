...
<div class="mx-auto flex flex-wrap py-6 px-8 flex-col md:flex-row items-center wrapper">
    <a class="flex title-font items-center white mb-4 md:mb-0" href="index.php">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-linecap="round"
            stroke-linejoin="round" stroke-width="2" class="w-16 h-16 text-white p-3 bg-blue-500 rounded-full"
            viewBox="0 0 24 24">
    ...
    <nav
        class="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center text-2xl justify-center font-medium">
